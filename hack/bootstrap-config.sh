...
kubectl -n kube-system annotate deployments kube-dns hpk-api-server='http://localhost:8000'
...
kubectl -n kube-system annotate deployments kube-dns hpk-max-runtime='300'
